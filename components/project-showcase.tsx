...
function ProjectCard({ project, index }: { project: typeof PROJECTS[0]; index: number }) {
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-2xl bg-card border border-border/50 transition-shadow duration-300 hover:shadow-2xl">
        ...
        <div className="p-6">
          <div className="flex items-start justify-between">
            <div>
              ...
              <h3 className="mt-1 font-serif text-xl font-semibold group-hover:text-gold transition-colors">
                {project.title}
              </h3>
            </div>
            <a
      ...
      <div className="mx-auto max-w-6xl px-4 lg:px-8">
        <div className="mb-12 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          <div>
            ...
            <h2 className="font-serif text-3xl font-bold tracking-tight sm:text-4xl">Selected work</h2>
            <p className="mt-3 text-muted-foreground max-w-xl">
              Real projects with measurable impact. Each one solved a specific business problem.
            </p>
          </div>

...
const TECH_STACK = [
  ...
  { name: 'LangChain', color: '#1C3C3C', position: [0, 4, 0] as [number, number, number] },
  { name: 'OpenAI', color: '#10A37F', position: [-3, 3.5, 1] as [number, number, number] },
  { name: 'n8n', color: '#EA4B71', position: [3, 3.5, 1] as [number, number, number] },
  { name: 'HuggingFace', color: '#FFD21E', position: [0, 3, -1] as [number, number, number] },
  { name: 'RAG Chatbot', color: '#8B5CF6', position: [-2.5, 4.2, 0.8] as [number, number, number] },
  { name: 'Agentic AI', color: '#EC4899', position: [2.5, 4.2, 0.8] as [number, number, number] },
  { name: 'Vector DB', color: '#10B981', position: [0, 2.5, 1] as [number, number, number] },
  ...
  { name: 'TypeScript', color: '#3178C6', position: [0, 2.2, 0.5] as [number, number, number] },
  { name: 'JavaScript', color: '#F7DF1E', position: [-1, 2.5, 0.5] as [number, number, number] },
  ...
  { name: 'Three.js', color: '#049EF4', position: [-4.5, 0, 0.8] as [number, number, number] },
  ...
  { name: 'Express', color: '#404040', position: [4.5, 0.8, 0.8] as [number, number, number] },
  ...
  // Auth & Payment (Lower)
  { name: 'JWT', color: '#6B6B6B', position: [-1, -2.5, 0.5] as [number, number, number] },
  ...
  // Tools & DevOps (Outer Ring)
  { name: 'Git', color: '#F05032', position: [-3.5, 2, -0.5] as [number, number, number] },
  { name: 'Docker', color: '#2496ED', position: [3.5, 2, -0.5] as [number, number, number] },
  { name: 'Vercel', color: '#404040', position: [4.5, -0.5, 0.5] as [number, number, number] },
  { name: 'AWS', color: '#FF9900', position: [4.5, -1.3, 0.5] as [number, number, number] },
